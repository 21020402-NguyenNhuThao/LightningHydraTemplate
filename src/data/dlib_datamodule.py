...
from src.data.components import init_dataset
from typing import Any, Dict, Optional, Tuple
...
class DLIBDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            data = init_dataset('dlib')
            f_len = len(data)
            val_len = int(f_len *0.1)
            test_len = val_len
            train_len = f_len - test_len - val_len
            train_val_test_split = [train_len, val_len, test_len]
    ...
    def draw_batch(self):
        ...
        key_points = batch['keypoints'] #n*68*2
